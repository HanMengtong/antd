export default {
  ...
  'menu.list': '客户信息',
  'menu.list.searchtable': '客户信息',
  'menu.list.basiclist': '意向跟进',
  ...
  'menu.profile.details': '查看详情页',
  'menu.profile.advanced': '高级详情页',
  'menu.result': '结果页',
  'menu.guanli': '客户管理',
  'menu.guanli.guanli_1': '客户管理',
  ...
  'app.settings.menuMap.record':'跟进设置',
  'app.settings.menuMap.notification': '新消息通知',
  'app.settings.basic.avatar': '更换头像',
  'app.settings.basic.email': '客户名称',
  'app.settings.basic.email-message': '请输入客户名称',
  'app.settings.basic.nickname': '联系人',
  'app.settings.basic.nickname-message': '请输入您的昵称!',
  'app.settings.basic.profile': '联系电话',
  'app.settings.basic.profile-message': '',
  'app.settings.basic.profile-placeholder': '联系电话',
  'app.settings.basic.country': '省区',
  'app.settings.basic.country-message': '请输入您的国家或地区!',
  'app.settings.basic.geographic': '省/区',
  'app.settings.basic.geographic-message': '请输入您的所在省市!',
  'app.settings.basic.address': '街道地址',
  'app.settings.basic.address-message': '请输入您的街道地址!',
  'app.settings.basic.phone': '联系电话',
  'app.settings.basic.phone-message': '请输入您的联系电话!',
  'app.settings.basic.update': '确定',
  'app.settings.basic.update1':'重置',
